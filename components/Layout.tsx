...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col bg-ios-bg text-ios-text overflow-hidden font-sans">
      ...
      <nav className="absolute bottom-0 left-0 right-0 z-40 pb-[env(safe-area-inset-bottom)] bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-t border-black/5 dark:border-white/10 shadow-[0_-1px_10px_rgba(0,0,0,0.02)]">
