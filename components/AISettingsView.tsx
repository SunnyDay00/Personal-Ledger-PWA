        ...
        <div className="overflow-hidden rounded-2xl border border-ios-border bg-white shadow-sm dark:bg-zinc-900">
          <GuideSection icon="Cpu" title="AI 如何查询账本" defaultOpen>
            <ol className="list-decimal space-y-1.5 pl-4">
              ...
              <li>系统提示词要求数据事实只能来自工具，同时允许模型基于本地结果自然比较、计算占比和解释趋势；分类或趋势结果会保留对应分组，本地只拦截“无查询却报数据、聚合冒充明细、零结果说成有记录”等明确冲突。</li>
            </ol>
          </GuideSection>
          ...
          <GuideSection icon="Database" title="支持范围与只读边界">
            <div className="space-y-2">
              <p>普通交流、能力询问或对回答的反馈会直接交给 DeepSeek 自然回应，不会为了聊天强制查询账本；涉及数据的问题、“收入呢”“为什么这么高”等数据追问，以及对上一轮查询建议回复“要”“好”“可以”“继续”时，都会延续意图并启用本地工具。</p>
          ...
          <GuideSection icon="Clock" title="上下文、压缩与调用限制">
            <ul className="list-disc space-y-1.5 pl-4">
              ...
              <li>上一轮的完整问答和精简查询轨迹会用于理解“要”“继续”“那半年呢”等追问；原始工具结果不会跨轮重复上传，涉及旧金额时会在本轮重新查询，以兼顾连续对话和数据时效性。</li>
              <li>发送问题后切换到首页、账本或设置，当前生成任务仍会在后台继续并保存；返回 AI 页面即可查看结果。</li>
              <li>超过窗口的旧消息会压缩为最多 2,000 字符的摘要；旧金额只作为历史结论，相关问题仍需重新查询。</li>
